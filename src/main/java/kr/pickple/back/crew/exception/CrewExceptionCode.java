...
public enum CrewExceptionCode implements ExceptionCode {
    ...
    CREW_MEMBER_ALREADY_EXISTED(HttpStatus.BAD_REQUEST, "CRE-004", "이미 가입 신청이 되거나 가입된 크루"),
    CREW_MEMBER_STATUS_NOT_FOUND(HttpStatus.NOT_FOUND, "CRE-005", "크루 가입자의 상태는 대기나 확정만 가능"),
    ;
